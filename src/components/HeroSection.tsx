    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section id="home" className="relative h-screen overflow-hidden">
        ...
        <Button
          ...
          size="icon"
          onClick={prevSlide}
          className="absolute left-6 top-1/2 transform -translate-y-1/2 z-20 bg-white/20 backdrop-blur-sm text-white hover:bg-white/30 transition-all duration-300"
        >
        ...
        <Button
          ...
          size="icon"
          onClick={nextSlide}
          className="absolute right-6 top-1/2 transform -translate-y-1/2 z-20 bg-white/20 backdrop-blur-sm text-white hover:bg-white/30 transition-all duration-300"
        >
            ...
            <div className="max-w-4xl">
              <div className="animate-fade-in-up">
                ...
                <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
                  Crafting Timeless Homes with Ayra Nirma
                </h1>
                <h2 className="text-2xl md:text-3xl text-amber-200 mb-6 font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-12">
                  <Button  onClick={handleEnquireNow} className="bg-amber-600 hover:bg-amber-700 text-white text-lg px-8 py-4 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300">
                    Get a Quote
                  </Button>
                  
                  <Dialog open={isWhatsAppOpen} onOpenChange={setIsWhatsAppOpen}>
                    <DialogTrigger asChild>
                      <Button variant="outline" className="border-2 border-white text-gray-900 text-lg px-8 py-4 rounded-full backdrop-blur-sm">
                        I'm Interested
                      </Button>
                    </DialogTrigger>
      ...
      >
        ...
        Send WhatsApp Message
                ...
                {/* Carousel Slider for Project Highlights */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {latestProjects.slice(0, 1).map((project) => (
      ...
      {/* 3. Achievements/Recognitions Section */}
      ...
      {/* 5. WhatsApp Integration Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-green-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              variant="outline" 
              className="border-2 border-white text-green-600 px-8 py-4 rounded-full text-lg"
      ...
      {/* 6. Social Feed Integration Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">
